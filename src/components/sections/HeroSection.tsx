  ...
  return (
    <section id="home" className="pt-16 md:pt-16" style={{ scrollMarginTop: "60px" }}>
      ...
      <div className="relative overflow-hidden" style={{ backgroundColor: "#0f0a00", minHeight: "520px" }}>
        ...
        {/* Text content */}
        <div className="relative z-10 flex flex-col justify-center" style={{ padding: "3rem 1.25rem", minHeight: "520px" }}>
          {/* Tagline */}
      ...
      {/* ── OUR SIGNATURES ── */}
      <div style={{ backgroundColor: "#0f0a00", padding: "4rem 1.25rem" }}>
        {/* Section header */}
